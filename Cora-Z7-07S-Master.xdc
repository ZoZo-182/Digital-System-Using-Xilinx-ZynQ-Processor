...
## Pmod Header JA
set_property -dict { PACKAGE_PIN Y18   IOSTANDARD LVCMOS33 } [get_ports { BTN_tri_io[0] }]; #IO_L17P_T2_34 Sch=ja_p[1]
set_property -dict { PACKAGE_PIN Y19   IOSTANDARD LVCMOS33 } [get_ports { BTN_tri_io[1] }]; #IO_L17N_T2_34 Sch=ja_n[1]
set_property -dict { PACKAGE_PIN Y16   IOSTANDARD LVCMOS33 } [get_ports { BTN_tri_io[2] }]; #IO_L7P_T1_34 Sch=ja_p[2]
...
## Pmod Header JB
set_property -dict { PACKAGE_PIN W14   IOSTANDARD LVCMOS33 } [get_ports { pmodleds[0] }]; #IO_L8P_T1_34 Sch=jb_p[1]
set_property -dict { PACKAGE_PIN Y14   IOSTANDARD LVCMOS33 } [get_ports { pmodleds[1] }]; #IO_L8N_T1_34 Sch=jb_n[1]
set_property -dict { PACKAGE_PIN T11   IOSTANDARD LVCMOS33 } [get_ports { pmodleds[2] }]; #IO_L1P_T0_34 Sch=jb_p[2]
set_property -dict { PACKAGE_PIN T10   IOSTANDARD LVCMOS33 } [get_ports { pmodleds[3] }]; #IO_L1N_T0_34 Sch=jb_n[2]
...
set_property -dict {PACKAGE_PIN E17 IOSTANDARD LVCMOS33} [get_ports Vaux1_1_v_p]
set_property -dict {PACKAGE_PIN D18 IOSTANDARD LVCMOS33} [get_ports Vaux1_1_v_n]
...
#set_property -dict { PACKAGE_PIN U14   IOSTANDARD LVCMOS33 } [get_ports { ck_io0 }]; #IO_L11P_T1_SRCC_34 Sch=ck_io[0] USE FOR PULL DOWN
...
#set_property -dict { PACKAGE_PIN T15   IOSTANDARD LVCMOS33 } [get_ports { ck_io3 }]; #IO_L5N_T0_34 Sch=ck_io[3] USE FOR PULL HIGH
...
set_property -dict {PACKAGE_PIN R17 IOSTANDARD LVCMOS33} [get_ports pwmDC]
...
set_property -dict {PACKAGE_PIN M18 IOSTANDARD LVCMOS33} [get_ports pwmBUZZER]
...
set_property -dict { PACKAGE_PIN J18   IOSTANDARD LVCMOS33 } [get_ports { PWMServo }]; #IO_L14P_T2_AD4P_SRCC_35 Sch=ck_io[12]
...
#set_property -dict { PACKAGE_PIN U12   IOSTANDARD LVCMOS33 } [get_ports { LCD_tri_i(1) }]; #IO_L2N_T0_34 Sch=ck_io[27] scl
#set_property -dict { PACKAGE_PIN U13   IOSTANDARD LVCMOS33 } [get_ports { LCD_tri_i(0) }]; #IO_L3P_T0_DQS_PUDC_B_34 Sch=ck_io[28]  sda
...
set_property -dict {PACKAGE_PIN G18 IOSTANDARD LVCMOS33} [get_ports Trigger]
set_property -dict {PACKAGE_PIN L20 IOSTANDARD LVCMOS33} [get_ports Echo]
